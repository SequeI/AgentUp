...
class TestOpenAIProviderFunctionCalling:
    ...
    async def test_function_calling_success(self):
        ...
        result = await self.provider._chat_complete_with_functions_native(
            messages, self.functions
        )
...
class TestOpenAIProviderEmbeddings:
    ...
    async def test_embed_success(self):
        ...
        # Verify API call
        self.provider.client.post.assert_called_once_with('/embeddings', json={
