"""Multi-modal support for handling images, files, and other content types."""
import base64
import hashlib
import io
import json
...
class MultiModalProcessor:
    ...
    @classmethod
    def save_image(cls, image: Image.Image, output_path: Union[str, Path],
    ...
    @classmethod
    def create_data_part(cls, file_path: Union[str, Path],
                        name: Optional[str] = None) -> Optional[DataPart]:
