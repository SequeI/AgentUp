...
def load_callable(path: Optional[str]) -> Optional[Callable[..., Any]]:
    """
...
def extract_parameter(text: str, param_name: str) -> Optional[str]:
...
__all__ = [
    'TaskValidator',
    'extract_parameter', 'format_response', 'sanitize_input',
