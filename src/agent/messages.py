...
class MessageProcessor:
    ...
    @staticmethod
    def get_latest_user_message(messages: List[Union[Message, Dict]]) -> Optional[Dict[str, Any]]:
    ...
    @staticmethod
    def get_conversation_history(messages: List[Union[Message, Dict]], limit: int = 10) -> List[Dict[str, Any]]:
...
__all__ = [
    'MessageProcessor', 'ConversationContext'
]