"""Tests for the create_agent CLI command (src/agent/cli/commands/create_agent.py)."""
...
from agent.cli.commands.create_agent import create_agent, configure_features
...
class TestCreateAgentCommand:
    ...
    def test_create_agent_interactive_mode(self, runner, mock_generator, mock_questionary, temp_dir, mock_template_features):
...
class TestServiceSelection:
    ...
    def test_service_selection_with_ollama(self, runner, mock_generator, mock_questionary, temp_dir, mock_template_features):
        """Test service selection when Ollama is chosen (critical test)."""
        # Mock questionary responses
        mock_questionary.text.return_value.ask.side_effect = [
            "ollama-service-test",
            "Test Ollama service selection"
        ]
    ...
    def test_service_selection_with_anthropic(self, runner, mock_generator, mock_questionary, temp_dir, mock_template_features):
    ...
    def test_service_selection_multiple_services(self, runner, mock_generator, mock_questionary, temp_dir, mock_template_features):
    ...
    def test_service_selection_always_runs_when_services_in_features(self, runner, mock_generator, mock_questionary, temp_dir, mock_template_features):
