"""HTTP client for AgentUp Skills Registry."""
...
class RegistryClient:
    ...
    def _get_cached_data(self, cache_key: str, max_age_minutes: int = 60) -> Optional[Dict[str, Any]]:
